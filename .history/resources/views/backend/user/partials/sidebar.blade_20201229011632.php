...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @if(Auth::user()->Type==="1" or Auth::user()->Type==="2" or Auth::user()->Type==="3" )
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_listing"
            aria-expanded="true" aria-controls="collapse_listing">
        ...
        <div id="collapse_listing" class="collapse" aria-labelledby="collapse_listing" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item"
                    href="{{ route('user.items.index') }}">{{ __('backend.sidebar.all-listings') }}</a>
                @endif
                @if(Auth::user()->Type==="1" or Auth::user()->Type==="2" or Auth::user()->Type==="3" )
                <a class="collapse-item"
                    href="{{ route('user.items.saved') }}">{{ __('backend.sidebar.saved-listings') }}</a>
                @endif
                ...
                @if(Auth::user()->Type==="1" or Auth::user()->isAdmin() or Auth::user()->Type==="2")
                <a class="collapse-item"
                    href="{{ route('user.items.create') }}">{{ __('backend.sidebar.new-listing') }}</a>
                @endif
            </div>
        </div>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_message"
            aria-expanded="true" aria-controls="collapse_message">
        ...
        <div id="collapse_message" class="collapse" aria-labelledby="collapse_message" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item"
                    href="{{ route('user.messages.index') }}">{{ __('backend.sidebar.all-messages') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_comment"
            aria-expanded="true" aria-controls="collapse_comment">
        ...
        <div id="collapse_comment" class="collapse" aria-labelledby="collapse_comment" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item"
                    href="{{ route('user.comments.index') }}">{{ __('backend.sidebar.all-comments') }}</a>
            </div>
        </div>
    </li>
    @endif
    @if(Auth::user()->Type==="1" or Auth::user()->Type==="2" )
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_review"
            aria-expanded="true" aria-controls="collapse_review">
        ...
        <div id="collapse_review" class="collapse" aria-labelledby="collapse_review" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item"
                    href="{{ route('user.items.reviews.index') }}">{{ __('review.backend.sidebar.all-reviews') }}</a>
            </div>
        </div>
    </li>
    @endif
