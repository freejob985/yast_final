                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12">
                        ...
                        <form method="post" action=" {{ route('user.Transforma') }}" class="p-5">
                            ...
                            <a href="{{ $plan->link }}" target="_blank" role="button"> 
                            <img src="https://icon-library.com/images/visa-mastercard-icon/visa-mastercard-icon-9.jpg" class="img-responsive" alt="Cinque Terre" target="_blank"></a>
