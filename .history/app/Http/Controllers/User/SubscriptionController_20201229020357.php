    ...
    public function Transformation(Request $request)
    {
        ...
        if ($Orders) {
            ...
            if ($plan->plan_price === "0.00") {
                ...
                $array['price']= $request->input('slug');
                $array['User']= $request->input('about_service');
                $array['id_u']= $request->input('project_cat_id');
                $array['subscription_end_date']= $request->input('project_cat_id');
                $array['plan_period']= $request->input('project_cat_id');
                $array['url']= $request->input('project_cat_id');
